            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div className="space-y-6">
                <p className="text-lg leading-relaxed">
                  ...
                  group assignment, I always try to bring a thoughtful,
                  problem-solving mindset to my work.
                </p>
              </div>
              <div className="space-y-6">
          ...
          <div className="project-grid">
            ...
            <div className="glass-card animate-slide-in-up">
              ...
              <p className="text-muted-foreground mb-4">
                ...
                ordering, real-time tracking, digital payments, and
                notifications to improve efficiency for students and canteen
                staff.
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
  ...
  <div className="container mx-auto max-w-4xl">
    <div className="glass-card animate-slide-in-up">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          <div className="glass rounded-lg p-4">
            <h4 className="font-bold text-primary">Oracle Certified Professional</h4>
          ...
          <div className="glass rounded-lg p-4">
            <h4 className="font-bold text-primary">Language Efficiency Certificate</h4>
